      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2">
          <div className="bg-white rounded-2xl shadow p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Complete your payment</h2>
            <p className="text-sm text-gray-500 mb-6">Secure checkout — choose a payment method and submit your booking request.</p>

            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <label className={`px-3 py-2 rounded-lg cursor-pointer border ${method === "card" ? "border-blue-500 bg-blue-50" : "border-gray-200 bg-white"}`}>
