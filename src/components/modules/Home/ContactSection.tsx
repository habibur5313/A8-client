          ...
          <div className="flex flex-col justify-center space-y-8 lg:pl-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-base font-medium text-slate-900">Email</h4>
                  <p className="mt-1 text-slate-600">hello@company.com</p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-base font-medium text-slate-900">Phone</h4>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-base font-medium text-slate-900">Office</h4>
            ...
            {/* Map Placeholder */}
            <div className="mt-8 h-48 w-full rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-400 text-sm">
