    ...
    <div className="min-h-screen  pb-20 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">{tour?.title}</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-10">
            {/* Tour info */}
            <div className="grid grid-cols-3 gap-4 p-6 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
              <div className="flex flex-col items-center text-center p-2">
                <Clock className="h-6 w-6 text-blue-600 dark:text-blue-500 mb-2" />
                <span className="text-xs text-gray-500 dark:text-gray-400 uppercase font-bold">Duration</span>
              ...
              <div className="flex flex-col items-center text-center p-2 border-l border-gray-100">
                <Users className="h-6 w-6 text-blue-600 dark:text-blue-500 mb-2" />
                <span className="text-xs text-gray-500 dark:text-gray-400 uppercase font-bold">Group Size</span>
                <span className="font-medium text-gray-900 dark:text-white">Max {tour?.maxGroupSize}</span>
              </div>
              <div className="flex flex-col items-center text-center p-2 border-l border-gray-100">
                <Globe className="h-6 w-6 text-blue-600 dark:text-blue-500   mb-2" />
                <span className="text-xs text-gray-500 dark:text-gray-400 uppercase font-bold">Languages</span>
                <span className="font-medium text-gray-900 dark:text-white">{tour?.language.join(', ')}</span>
              </div>
            </div>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">{tour?.description}</p>
            </section>
            ...
            <section className="bg-blue-50 dark:bg-gray-800 p-6 rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white text-lg">Guided by {tour?.guide?.name}</h3>
                  <p className="text-blue-600 dark:text-blue-500 text-sm font-medium">Certified Local Guide</p>
                </div>
              </div>
            ...
            {/* Reviews */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Reviews ({reviews.length})</h2>
