    ...
    <div className="relative inline-block text-left">
      <div className="flex items-center">
        ...
        <select
          ...
          className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-md shadow-sm cursor-pointer bg-white"
